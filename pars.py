...
print('Введите название файла прайс-листа магазина')
name_of_icar_price_list = input()
print('Введите название листа из файла магазина')
name_of_icar_price_list_sheet = input()

print('Введите название файла прайс-листа дистрибьютора')
name_of_distributor_price_list = input()
print('Введите название листа из файла магазина дистрибьютора')
name_of_distributor_price_list_sheet = input()

article_name_dict_icar = {}
article_name_dict_dist = {}

f = open("your DIR", 'w', encoding='utf-8')
